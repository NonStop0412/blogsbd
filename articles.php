                  ...
                  <article class="article">
                    ...
                    <div class="article__info">
                      ...
                      <div class="article__info__meta">
                        ...
                        ?>
                        <small>Категория: <a href="/articles.php?cateforie=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a></small>
                      </div>
...
if ( $articles_exist == true )
{
  ...
  if ( $page < $total_pages)
  {
    echo '<a href="/articles.php?page='.($page + 1).'">  Следущая страница  &raquo;</a>';
  }
  echo '</div>';
}
   ?>
