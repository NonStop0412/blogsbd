          ...
          <section class="content__left col-md-8">
            <div class="block">
              ...
              <div class="block__content">
                ...
                <div class="full-text">
                  Запрашиваема вами статья не существует!
    ...
    ?>
                  <article class="article">
                    ...
                    <div class="article__info">
                      <a href="/article.php?id=<?php echo $comment['articles_id']; ?>"><?php echo $comment['name']; ?></a>
...
if ( empty($errors) )
{
 ...
 mysqli_query($connection," INSERT INTO `comments` (`name`, `email`, `text`, `pubdate`, `articles_id`) 
  VALUES ('".$_POST['name']."', '".$_POST['email']."', '".$_POST['text']."', NOW(), '".$art['id']."' ) ");

 echo '<span style="color: green; fotn-weight: bold; Margin-bottom: 10px; display: block;">Комментарий успешно добавлен!</span>';
} else
{
// вывести ошибку
